...
def order_calculation(i, configuration):
    ...
    #    spectrograph.detector_subpixel[:, :, order], order_y_subpix_min[order], i = slice_calculation(
    #        i, slice, configuration)
    ...
    psf_map = tools.interpolate_psf_map(
        psf_map_shape, spectrograph.psf_map[i][1][0][1], wavelength, order_wavelength_subpix)
    # [0] per SOXS
    ...
    return order_detector_subpixel, order_y_subpix_min[i], i, 0
